...
function setUniform(job, playerPed)
  TriggerEvent('skinchanger:getSkin', function(skin)
    ...
    if skin.sex == 0 then
      ...
      if job ~= 'citizen_wear' and job ~= 'government_outfit' then
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    { label = _U('government_outfit'),    value = 'government_outfit'},
    { label = _U('government_outfit_1'),  value = 'government_outfit_1'},
    { label = _U('government_outfit_2'),  value = 'government_outfit_2'},
    { label = _U('government_outfit_3'),  value = 'government_outfit_3'},
    { label = _U('government_outfit_4'),  value = 'government_outfit_4'},
    { label = _U('government_outfit_5'),  value = 'government_outfit_5'}
  }
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if
        data.current.value == 'government_outfit' or
        data.current.value == 'government_outfit_1' and ESX.PlayerData.job.grade_name == 'law' or  IsGradeBoss() or
        data.current.value == 'government_outfit_2' and ESX.PlayerData.job.grade_name == 'judge' or IsGradeBoss() or
        data.current.value == 'government_outfit_3' and ESX.PlayerData.job.grade_name == 'sec' or IsGradeBoss() or
        data.current.value == 'government_outfit_4' and ESX.PlayerData.job.grade_name == 'mayor' or IsGradeBoss() or
        data.current.value == 'government_outfit_5' and IsGradeBoss()
      then
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_government', _U('billing'), amount)
        end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_government:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_government:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_government:addVaultWeapon', function()
        OpenPutWeaponMenu()
...
function OpenGovernmentActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'gov_actions', {
		title    = 'Government',
		align    = 'top-left',
		elements = {
			{label = _U('billing'), value = 'bill'},
			{label = _U('comserve'), value = 'comserve'}
  }}, function(data, menu)
    local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
          ...
          if data.current.value == 'bill' then
            OpenBillingMenu()
          elseif data.current.value == 'comserve' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction then
      ...
      if IsControlJustReleased(0,  Keys['E']) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'government' then
        ...
        elseif CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'government', vehicleProps)

          else

            if
            (
              GetEntityModel(vehicle) == GetHashKey('technical1') or 
              GetEntityModel(vehicle) == GetHashKey('technical2') or
              GetEntityModel(vehicle) == GetHashKey('barrage') or
    ...
    if IsControlJustReleased(0,  Keys['F6']) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'government' then
